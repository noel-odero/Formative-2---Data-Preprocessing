...
3. **Task 3** — compile voice recordings, extract key audio features, and implement a voiceprint authentication model using a hybrid Random Forest and CNN approach..
